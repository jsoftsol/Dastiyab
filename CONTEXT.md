...
- **`.claude/settings.json` `SessionStart` hook** — auto-injects `CONTEXT.md` + `docs/AGENT_NOTES.md` into every new session via `.claude/hooks/session-start-context.mjs`
